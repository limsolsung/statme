...
- **Differentiation:** 경쟁앱들이 파스텔 라이트(Finch) 또는 픽셀아트 원색(Habitica)인 반면, StatMe는 크림 배경 + 테라코타 액센트 + 한글 픽셀 폰트로 따뜻하면서 세련된 소프트 레트로 감성
...
| 2026-04-02 | 앱 이름 StatMe 유지 | 스탯+미 조합이 컨셉을 잘 전달하면서도 게임 세계관을 강요하지 않음 |
